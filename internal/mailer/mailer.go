...
func (m Mailer) Send(recipient, templateFile string, data any) error {
	...
	// Follow the same pattern to execute the "plainBody" template and store the result// Follow the same pattern to execute the "plainBody" template and store the result
